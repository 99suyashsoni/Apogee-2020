...
class _ProfileScreenState
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<DocumentSnapshot>(
        stream:
            Firestore.instance.collection('users').document("5889").snapshots(),
                    ...
                    Expanded(
                      ...
                      child: Consumer<MyProfileModel>(
                        builder: (context, myProfileModel, child) {
                          ...
                          return myProfileModel.isLoading
                              ? Center(
                                    ...
                                    children: <Widget>[
                                      ...
                                      TextField(
                                        ...
                                        decoration: InputDecoration(
                                            ...
                                            errorText: myProfileModel.validInput
                                                ? null
                                                : 'Enter valid amount'),
...
class MyProfileModel with ChangeNotifier {
  ...
  MyProfileModel({WalletDao walletDao, CustomHttpNetworkClient networkClient})
